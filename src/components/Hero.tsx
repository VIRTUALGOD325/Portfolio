...
const Hero = () => {
  ...
  const roles = ['Full Stack Developer', 'Frontend Specialist', 'UI/UX Enthusiast', 'Tech Innovator', 'ML Engineer'];
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center space-x-6 pt-8">
              {[
                ...
                { icon: Linkedin, href: 'http://linkedin.com/in/tanishq-nabar-4768ab315', label: 'LinkedIn' },
                { icon: Mail, href: 'tanishqnabar10@gmail.com', label: 'Email' }
