...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'A collaborative workspace for teams with real-time editing, video calls, and project management features. Built with Socket.io and WebRTC.',
      image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=600&h=400&fit=crop',
      technologies: ['Vue.js', 'Socket.io', 'WebRTC', 'Express'],
      liveUrl: '#',
      githubUrl: '#'
    }
  ];
